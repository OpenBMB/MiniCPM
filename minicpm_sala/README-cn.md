...
- **性能：** 与 Transformer 基线模型（如 Qwen3-8B）相比，MiniCPM-SALA 在长上下文设置下实现了高达**3.5倍的推理加速**，显著降低了计算和KV缓存的开销。
...
使用 MiniCPM-UltraAttn 高效地构建惊人的长上下文应用，为您带来无与伦比的上下文理解能力和速度！
...
- **研究者：** 利用 Transformers Trainer、LLaMA-Factory 等高级框架，进行灵活的模型开发和前沿实验。
...
| **框架**                                         | **描述**                       |
| ------------------------------------------------ | ------------------------------ |
| [**Transformers Trainer**](./finetune/README.md) | 最适合底层自定义，灵活性最高。 |
| [**LLaMA-Factory**](./finetune/README.md)        | 模块化微调工具包。             |
...
- 发现了错误？[提交 Issue](https://www.google.com/search?q=%23&authuser=2)
...
本指南基于 [Apache-2.0 License](TODO: 填写许可证链接) 提供——自由“烹饪”，慷慨分享！🍳
