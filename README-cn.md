...
## 更新日志🔥
- 📌 [2026.05.19] **[MiniCPM5-1B](https://huggingface.co/openbmb/MiniCPM5-1B)** 发布！面向端侧与资源受限场景，在 1B 参数量上追求更高能力密度，并配套部署 / 微调 [Agent Skills](./skills/)。🔥🔥🔥
...
MiniCPM5 是面壁智能新一代端侧模型家族。首发的 **MiniCPM5-1B** 是一款紧凑稠密的 1B Transformer，定位于在 1B 参数量上把"每参数能力密度"做到最高，并配套 RL 后训练、单页 cookbook 与面向 coding agent 的部署 / 微调 Skill。
