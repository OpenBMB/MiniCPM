...
| 顶层 Skill | 作用 | 路由到 |
| --- | --- | --- |
| **[`minicpm5-deploy`](./skills/minicpm5-deploy/SKILL.md)** | 推理路由 | `transformers` · `vllm` · `sglang` · `llama-cpp` · `ollama` · `lmstudio` · `mlx` · `mnn` |
...
| [MNN](https://github.com/alibaba/MNN) | 移动端 / 端侧推理（Android / iOS） | [`docs/deployment/mnn.md`](./docs/deployment/mnn.md) | [`minicpm5-deploy-mnn`](./skills/minicpm5-deploy-mnn/SKILL.md) |
